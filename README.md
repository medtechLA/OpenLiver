...
1. **OpenLiver Simulation (Data Generation)**  
...
2. **LiverMatch (Model Training & Evaluation)**
    Original implementation: https://github.com/zixinyang9109/LiverMatch
    Deep learning model for training and evaluating correspondence-based liver registration models using the data generated by OpenLiver .

Together, these two modules provide a full workflow for **camera-consistent full-to-partial registration in open liver surgery**, reproducing the experiments from our study.
